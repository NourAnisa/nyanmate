...
function control(action: 'prev' | 'next' | 'question' | 'discussion' | 'cue-prev' | 'cue-next' | 'auto' | 'end') { void emit('presenter-control', { action }) }
...
<template>
  <main class="presenter-console">
    ...
    <footer>Presenter Console stays on the lecturer screen. The projector window shows only the PDF and NyanMate lesson choreography.</footer>
  </main>
</template>
